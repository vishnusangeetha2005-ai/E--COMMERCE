      ...
      <main className="max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        {cart.length === 0 ? (
          <div className="text-center py-16">
            ...
            <Link href={`${base}/products`} className="btn-primary inline-block mt-4">Continue Shopping</Link>
          </div>
        ) : (
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="card h-fit">
              ...
              <Link href={`${base}/checkout`} className="btn-primary w-full text-center mt-4 block">Proceed to Checkout</Link>
            </div>
          </div>
        )}
      </main>
