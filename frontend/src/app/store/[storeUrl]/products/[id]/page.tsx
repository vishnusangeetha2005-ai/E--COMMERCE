...
export default function StoreProductDetailPage() {
  ...
  useEffect(() => { if (storeUrl && id) loadProduct(); }, [storeUrl, id]);
  ...
  if (!product) return <><Navbar storeUrl={storeUrl} /><div className="flex justify-center py-20"><div className="animate-spin rounded-full h-12 w-12 border-b-2 border-primary-600" /></div></>;
